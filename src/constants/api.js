import {API_URL_USER_QUALIFIER, API_URL_LANGUAGE_QUALIFIER} from './api/apiUrlQualifier';
import {API_URL_SORT_PARAMETER, API_URL_ORDER_PARAMETER, API_URL_PAGE_PARAMETER, API_URL_PER_PAGE_PARAMETER} from './api/apiUrlParameter';
...
// &stars:>=1
// export const API_URL_REPO_OPTIONS = `?q=${API_URL_USER_QUALIFIER}+${API_URL_LANGUAGE_QUALIFIER}+&${API_URL_SORT_PARAMETER}+&${API_URL_ORDER_PARAMETER}+&${API_URL_PAGE_PARAMETER}+&${API_URL_PER_PAGE_PARAMETER}`
